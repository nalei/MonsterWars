...
class Munch: GKEntity {
  ...
  init(player: Player, entityManager: EntityManager) {
    ...
    addComponent(MeleeComponent(damage: 50, destroySelf: false, damageRate: 2.5, aoe: true, sound: SoundManager.sharedInstance.soundBigHit, entityManager: entityManager))
